                    ...
                    <form method="post" class="bg-light rounded p-4 p-sm-5 my-4 mx-3">
                        <div class="d-flex align-items-center justify-content-between mb-3">
                            <a href="index.html" class="">
                                <h3 class="text-primary"><i class="fa fa-hashtag me-2"></i><?= $app_name ?></h3>
                            </a>
                            <h3>Sign In</h3>
                        </div>
                        ...
                        <?php
                            if(isset($_POST['login'])){
                                ...
                                if($hitung > 0){
                                    //Berfungsi untuk mnyimpan data dari database ke array $data
                                    $data = mysqli_fetch_array($cek);
                                    //echo"<div class='alert alert-success'>Selamat datang abang <b>".$data['nama']."</b>.</div>";

                                    //Proess menyimpan ke dalam session
